...
# secret : 35ijt4q00kfvnclsb67q0rk0dmqieace
# tigergraph 연결
hostname = "http://3.38.37.197/"
graphName = "Movie"
# authToken = "v9l8077mu8lqsllc1dh6ikql80r3om29"
ID = "tigergraph"
PW = "1120"
#conn = tg.TigerGraphConnection(host=hostname, graphname=graphName, username=ID, password=PW, apiToken=authToken)
conn = tg.TigerGraphConnection(host=hostname, graphname=graphName, username=ID, password=PW)


# kafka consumer 연결
Server = '3.37.174.253:9092'
